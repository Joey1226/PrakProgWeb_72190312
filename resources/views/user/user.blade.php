                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            ...
                            <form class="form-inline my-2 my-lg-0 float-right" method="GET" action="/dosen/cari">
                                ...
                                <button class="btn btn-outline-primary my-2 my-sm-0" type="submit">Cari User</button>
                            </form>
                        </div>
                        <div class="card-body">
                            @if (session('alert'))
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/user/hapususer/{{ $u->id }}" class="btn btn-outline-primary"><i class="bi bi-x-square"></i>Hapus</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
